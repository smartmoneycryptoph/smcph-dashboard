...
const SOCIALS = [
  {
    id: "telegram",
    label: "Telegram",
    description: "Join our trading signals group",
  ...
  },
  {
    id: "youtube",
    label: "YouTube",
    description: "Watch our trade breakdowns and analysis",
    url: "https://youtube.com/@smartmoneycryptoph", // UPDATE THIS
    icon: YoutubeLogo,
    color: "text-rose-400",
  ...
  },
  {
    id: "facebook",
    label: "Facebook",
    description: "Follow for daily market updates",
    url: "https://facebook.com/smartmoneycryptoph", // UPDATE THIS
    icon: FacebookLogo,
    color: "text-blue-400",
  ...
  },
  {
    ...
    url: "https://instagram.com/smartmoneycryptoph", // UPDATE THIS
    icon: InstagramLogo,
    color: "text-pink-400",
  ...
  },
  {
    ...
    url: "https://x.com/smartmoneycryptoph", // UPDATE THIS
    icon: XLogo,
    color: "text-zinc-300",
